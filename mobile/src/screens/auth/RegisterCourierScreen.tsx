...
const RegisterCourierScreen = ({ navigation }: any) => (
  <View style={styles.container}>
    <Text style={styles.icon}>🛵</Text>
    <Text style={styles.title}>Registro de domiciliario</Text>
    <Text style={styles.text}>
      Para registrarte como domiciliario necesitás subir tu cédula (frente y reverso) y la documentación del vehículo.
    </Text>
    <Text style={styles.text}>
