...
import {
  LayoutDashboard, Users, ShieldCheck, ScrollText, Wallet, BarChart3, DatabaseBackup, Lock, Search,
} from "lucide-react";
...
const menuItems: MenuItem[] = [
  ...
  { label: "Índice de búsqueda", path: "/admin/dashboard/indice", icon: <Search size={24} /> },
];
